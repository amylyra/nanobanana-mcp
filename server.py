...
mcp = FastMCP(
    ...
    instructions=(
        ...
        "## Image URL rules\n"
        "- User gave an http/https URL → pass it directly.\n"
        "- Tool returned a URL → reuse it.\n"
        "- User shared a Google Drive link → use the Google Drive MCP to get a direct download URL "
        "for the file, then pass that URL to upload_image.\n"
