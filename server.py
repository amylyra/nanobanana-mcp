...
mcp = FastMCP(
    ...
    instructions=(
        ...
        "   - If curl fails (DNS error, network error, timeout): do NOT try base64 encoding."
        " Instead, ask the user to upload manually at {upload_url}/upload and paste the URL back.\n"
        "   - Without bash: direct user to {upload_url}/upload to upload manually.\n\n"
        "Never fabricate URLs. Never pass base64 strings as MCP parameters — they always get truncated. "
        "If you cannot get an http/https URL for an image, ask the user to upload it at {upload_url}/upload. "
